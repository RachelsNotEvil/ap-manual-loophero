...
### Loops
You start the game with 1 loop, and items giving you more loops are in the pool. When the loop counter in the game exceeds your current loop total, you must end the current run. If you get every item, you will accumulate a total of 24 loops. (If you want, you can consider yourself to have infinite loops at that point.) Every location that expects you to have more than 3 loops also expects you to have at least 1 equip slot because with no equipment it can become difficult just to survive the slimes.
