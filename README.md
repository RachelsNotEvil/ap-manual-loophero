...
The first thing to do is create an empty supply loadout. Since you do not start with any supply items, this is the loadout you will use to begin with. When you generate the game, it will give you items representing your character class, your starting chapter, 1 loop, 1 supply capacity (explained below), and the 7 cards in your starting deck. You can then check these items and make your starting deck out of those first 7 cards. **If the game fails to give you enough of the right kind of cards to create a valid deck at the start, this is an error and you should notify me on the game's post in the Manual for Archipelago discord.**
