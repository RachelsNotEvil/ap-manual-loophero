...
def after_create_regions(world: World, multiworld: MultiWorld, player: int):
    ...
    if option_choice < 2:
        locationNamesToRemove.append("Kill Ghost of a Ghost")
    if option_choice < 1:
        locationNamesToRemove.append("Kill Ghost")
...
def before_create_items_all(item_config: dict[str, int|dict], world: World, multiworld: MultiWorld, player: int) -> dict[str, int|dict]:
    option_choice = get_option_value(multiworld, player, "character_class")
    if option_choice != 0:
        item_config.pop("Warrior")
        item_config.pop("Weapon")
        item_config.pop("Shield")
        item_config.pop("Ring")
    if option_choice != 1:
        item_config.pop("Rogue")
        item_config.pop("Main Weapon")
        item_config.pop("Off-Hand Weapon")
        item_config.pop("Boots")
    if option_choice != 2:
        item_config.pop("Necromancer")
        item_config.pop("Book (Weapon)")
        item_config.pop("Right Ring")
        item_config.pop("Left Ring")
